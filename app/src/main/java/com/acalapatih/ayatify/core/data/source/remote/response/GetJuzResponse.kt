...
data class GetJuzResponse(
	...
	data class Data(
		...
		@field:SerializedName("juzStartSurahNumber")
		val juzStartSurahNumber: Int? = null,

		@field:SerializedName("totalVerses")
		val totalVerses: Int? = null,

		@field:SerializedName("juzEndSurahNumber")
		val juzEndSurahNumber: Int? = null,

		@field:SerializedName("juzStartInfo")
		val juzStartInfo: String? = null,

		@field:SerializedName("juzEndInfo")
		val juzEndInfo: String? = null,
